...
class OnlineEcommerceTextTheme{
  OnlineEcommerceTextTheme._();
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal, color: Colors.grey),
